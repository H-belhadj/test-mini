...
#    Updated: 2023/11/03 21:39:09 by hbelhadj         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCE = minishell.c ./lexer/tokens.c ./parser/sort_cmds.c  cmp.c  ./parser/expand.c ./parser/remove_quotes.c \
		...
		./exec/cd.c ./exec/env_export.c ./exec/env.c ./exec/execut.c ./exec/exit.c ./exec/export.c ./exec/ft_echo.c ./exec/ft_getenv.c ./exec/path.c ./exec/pipes.c ./exec/pwd.c ./exec/unset.c
